...
(function() {
  ...
  var translations = {
    tr: {
      ...
      hero_title: "Ahşabın Zamana<br/>Bıraktığı <em>İz</em>",
      hero_desc: "Atölyemizde her parça, özenle seçilmiş kayın ağacından tek tek elde şekillenir; ustanın elinde yaşam alanlarınıza karakter katan birer esere dönüşür.",
      ...
      cat_vases_desc: "Kayın ağacından, damla ve şişe formlarında dekoratif vazolar.",
      ...
      about_p2: "Sert ve dayanıklı kayın ağacından ürettiğimiz ürünlerimiz, doğal dokusu ve sıcaklığıyla yaşam alanlarınıza karakter katıyor. Kaliteden ödün vermeden, sürdürülebilir üretim anlayışıyla çalışıyoruz.",
    ...
    en: {
      ...
      nav_contact: "Contact",
      hero_badge: "masif special",
      hero_title: "Where Wood<br/>Meets <em>Time</em>",
      hero_desc: "Every piece is shaped by hand from carefully selected beech wood in our workshop, becoming works of quiet character in the maker's hands.",
      ...
      cat_vases_desc: "Beech wood decorative vases in drop and bottle forms.",
      ...
      about_p1: "We deliver nature's purest form to your hands. Each product is specially shaped for you by master craftsmen.",
